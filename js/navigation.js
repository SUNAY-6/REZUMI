    ...
    list.innerHTML = resumes.map(r => `
        <div class="library-item" style="margin-bottom:8px;">
            ...
            <div class="library-item-actions">
                <button onclick="openResume('${r.id}')" title="Preview"><i class="fas fa-eye"></i></button>
                <button onclick="deleteResumeItem('${r.id}')" title="Delete"><i class="fas fa-trash"></i></button>
            </div>
        </div>
    `).join('');
}
